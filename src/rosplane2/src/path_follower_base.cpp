...
path_follower_base::path_follower_base():
  nh_(rclcpp::NodeHandle()),
  nh_private_(rclcpp::NodeHandle("~"))
{
  ...
  func_ = std::bind(&path_follower_base::reconfigure_callback, this, _1, _2);
...
void path_follower_base::update(const rclcpp::TimerEvent &)
{
  ...
  if (state_init_ == true && current_path_init_ == true)
  {
    ...
    rosplane_msgs::msg::Controller_Commands msg;
...
void path_follower_base::vehicle_state_callback(const rosplane_msgs::msg::StateConstPtr &msg)
{
...
void path_follower_base::current_path_callback(const rosplane_msgs::msg::Current_PathConstPtr &msg)
{
...
int main(int argc, char **argv)
{
  ...
  rosplane2::path_follower_base *path = new rosplane::path_follower_example();
