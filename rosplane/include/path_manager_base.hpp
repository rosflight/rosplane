...
private:
  ...
  rclcpp::Subscription<rosplane_msgs::msg::State>::SharedPtr vehicle_state_sub_;     /**< vehicle state subscription */
  rclcpp::Subscription<rosplane_msgs::msg::Waypoint>::SharedPtr new_waypoint_sub_;      /**< new waypoint subscription */
  rclcpp::Publisher<rosplane_msgs::msg::CurrentPath>::SharedPtr current_path_pub_;     /**< controller commands publication */
