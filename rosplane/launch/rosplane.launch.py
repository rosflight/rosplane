...
def generate_launch_description():
    ...
    estimator_params = PathJoinSubstitution([rosplane_share, 'params', 'estimator.yaml'])
        ...
        [
            ...
            Node(
                ...
                remappings=[
                    (
                        '/command',
                        launch.substitutions.LaunchConfiguration('command_publisher_remap'),
                    ),
                    (
                        '/estimated_state',
                        launch.substitutions.LaunchConfiguration('state_topic_remap'),
                    ),
                ],
            ),
            Node(
